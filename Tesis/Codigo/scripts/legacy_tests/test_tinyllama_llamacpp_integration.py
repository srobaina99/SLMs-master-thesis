#!/usr/bin/env python3
"""
Integration test for TinyLlama llama.cpp wrapper.
...
from src.evaluation.experiment_framework.models import TinyLlamaLlamaCppWrapper
from src.evaluation.experiment_framework.core.data_models import ExperimentConfig


def test_tinyllama_llamacpp():
    """Run integration test for TinyLlama llama.cpp wrapper."""
    
    print("\n" + "="*60)
    print("TINYLLAMA LLAMACPP INTEGRATION TEST")
    print("="*60)
    
    # Initialize wrapper
    print("\n[1/5] Initializing TinyLlamaLlamaCppWrapper...")
    print("      ⏳ Loading GGUF model from disk (this may take 10-20 seconds)...")
    
    start_load = time.time()
    wrapper = TinyLlamaLlamaCppWrapper()
    ...
    print(f"\n🎯 TinyLlama llama.cpp wrapper is ready for experiments!")
    
    return True


if __name__ == "__main__":
    success = test_tinyllama_llamacpp()
